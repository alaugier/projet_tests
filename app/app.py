...
try:
    model = load(os.path.join(BASE_DIR, "models", "model_logreg.joblib"))
except Exception as e:
    print(f"Erreur de chargement du modèle : {e}")
    model = None  # pour éviter les NameError

try:
    vectorizer = load(os.path.join(BASE_DIR, "models", "tfidf_vectorizer.joblib"))
except Exception as e:
